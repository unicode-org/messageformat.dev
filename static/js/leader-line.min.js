...
var LeaderLine = function () {
  ...
  var Z,
    ...
    g = (_ = {
      ...
      x = 0,
      {
        add: function (n, e, t, a, i, o, l) {
          ...
          if (
            "string" == typeof i && (i = _[i]), n = n || function () {}, t < v
          ) r = [g(0, 0), g(1, 1)];
          else {
            if (
              s = v / t,
            ...
            ) { for (h = s; h <= 1; h += s) r.push(g(h, h)); } else {for (
                p = u = (h = s) / 10;
                p <= 1;
                p += u
              ) {
    ...
    ce = function (e) {
      e.SVGPathElement.prototype.getPathData &&
          e.SVGPathElement.prototype.setPathData || function () {
        function i(e) {
          this._string = e,
        ...
        i.prototype = {
          parseSegment: function () {
            var e = this._string[this._currentIndex], t = a[e] || null;
            if (null === t) {
              if (null === this._prevCommand) return null;
              if (
                null ===
                  (t = ("+" === e || "-" === e || "." === e ||
                      "0" <= e && e <= "9") && "Z" !== this._prevCommand
                    ? "M" === this._prevCommand
                      ? "L"
                      : "m" === this._prevCommand
                      ? "l"
            ...
            var n = null, e = (this._prevCommand = t).toUpperCase();
            return "H" === e || "V" === e
              ? n = [this._parseNumber()]
              : "M" === e || "L" === e || "T" === e
        ...
        var s = e.SVGPathElement.prototype.setAttribute,
          ...
          b = function (e, t, n, a, i, o, l, r, s, u) {
            ...
            var p = Math.PI * l / 180, c = [];
            u
              ? (_ = u[0], v = u[1], S = u[2], g = u[3])
              : (e = (m = h(e, t, -p)).x,
                t = m.y,
                1 <
                  (m = (y = (e - (n = (f = h(n, a, -p)).x)) / 2) * y / (i * i) +
                    (d = (t - (a = f.y)) / 2) * d / (o * o)) &&
                (i *= m = Math.sqrt(m), o *= m),
                f = i * i,
                m = o * o,
            ...
            var c = [S, _, a].concat(c).join().split(","), E = [], x = [];
    ...
    S = (a = {},
      Ee.m = n = [function (e, t, n) {
        n.r(t);
        var a = 500,
          i = [],
          o = window.requestAnimationFrame || window.mozRequestAnimationFrame ||
            window.webkitRequestAnimationFrame ||
            window.msRequestAnimationFrame || function (e) {
        ...
        t.default = {
          add: function (e) {
            var t = void 0;
            return -1 === h(e)
              ? (i.push(t = { listener: e }), function (e) {
                t.event = e, s || u();
              })
              : null;
          },
  ...
  function xe() {
    ...
    e && (r.call(window, e), e = null),
      E.forEach(function (e) {
        ...
        if (e.framesStart) {
          if (
            (t = i - e.framesStart) >= e.duration && e.count && e.loopsLeft <= 1
          ) {
            return a =
  ...
  function ke(t, n) {
    ...
    return typeof t != typeof n ||
      ...
      ("obj" === e
        ...
        : "array" === e
        ? t.length !== n.length || t.some(function (e, t) {
          return ke(e, n[t]);
        })
        : t !== n);
  }
  ...
  function Oe(e) {
    ...
    return (t = /^(rgba|hsla|hwb|gray|device\-cmyk)\s*\(([\s\S]+)\)$/i.exec(e))
      ? (n = t[1].toLowerCase(),
  ...
  function Te(n, a, i, o, e) {
    function l(e, t, n, a, i) {
      return e *
          (e * (-3 * t + 9 * n - 9 * a + 3 * i) + 6 * t - 12 * n + 6 * a) -
        3 * t + 3 * n;
    }
    var r,
      s,
  ...
  function We(e, t, n, a, i) {
    for (
      var o, l = .5, r = 1 - l;
      o = Te(e, t, n, a, r), !(Math.abs(o - i) <= .01);
    ) r += (o < i ? 1 : -1) * (l /= 2);
    return r;
  }
  function Be(e, t) {
    ...
    return e.forEach(function (e) {
      ...
      (n = n || [{ type: "M", values: [e[0].x, e[0].y] }]).push(
        e.length
          ? 2 === e.length ? { type: "L", values: [e[1].x, e[1].y] } : {
            type: "C",
  ...
  function Fe(e, a) {
    return null == e || null == a || e.length !== a.length ||
      e.some(function (e, t) {
        var n = a[t];
  ...
  function De(e, t, n) {
    var a;
    e.events[t] && -1 < (a = e.events[t].indexOf(n)) &&
  ...
  function Ye(n, a) {
    Object.keys(a).forEach(function (e) {
      var t = a[e];
      n[e] = null != t.iniValue
        ? t.hasSE ? [t.iniValue, t.iniValue] : t.iniValue
        : t.hasSE
        ? t.hasProps ? [{}, {}] : []
        : t.hasProps
        ? {}
  ...
  function Ke(l) {
    ...
    if (
      f.position_path = p.path,
        ...
        c = [0, 1].map(function (e) {
          var t = p.anchorSE[e],
            ...
            a = !1 !== n ? _e[t._id] : null,
            i = !1 !== n && a.conf.getStrokeWidth
              ? a.conf.getStrokeWidth(a, l)
              : 0,
            o = !1 !== n && a.conf.getBBoxNest
              ? a.conf.getBBoxNest(a, l, i)
              : Le(t, l.baseWindow);
          return f.capsMaskAnchor_pathDataSE[e] = !1 !== n && a.conf.getPathData
        ...
        [0, 1].some(function (e) {
          return f.position_plugOverheadSE[e] !==
              y.position_plugOverheadSE[e] ||
            (t = v[e],
      ...
      switch (
        l.pathList.baseVal = _ = [], l.pathList.animVal = null, f.position_path
      ) {
        case P:
          _.push([E(v[0]), E(v[1])]);
          break;
        case N:
          t = "number" == typeof g[0] && 0 < g[0] ||
              ...
              var n,
                ...
                i = Array.isArray(a)
                  ...
                  ? e.socketId === b
                    ...
                    : { x: -a, y: 0 }
                  : (n = v[t ? 0 : 1],
                    a = 0 < (a = f.position_plugOverheadSE[t])
                      ? U + (K < a ? (a - K) * J : 0)
                      : z + (f.position_lineStrokeWidth > j
              ...
              function () {
                ...
                if (o[0] === o[1]) {
                  ...
                  n[0] !== n[1]
                    ...
                    : (i = [{ x: u[0].x, y: u[0].y }, { x: u[1].x, y: u[1].y }],
                      s.forEach(function (e, t) {
      ...
      d = [],
        ...
        m = !0,
        l.events.apl_position && l.events.apl_position.forEach(function (e) {
          e(l, _);
        });
    }
    return m;
  ...
  function $e(e, t) {
    ...
    (U.line =
      (i = (n = e).options,
        ...
        l = Xe(n, a, "line_strokeWidth", i.lineSize, o.cur_line_strokeWidth) ||
          l)),
      (t.plug || U.line) &&
      (U.plug =
        (p = (h = e).options,
      ...
      (U.lineOutline =
        (o = (i = e).options,
          ...
          k = Xe(i, l, "lineOutline_strokeWidth", l.line_strokeWidth - 2 * o) ||
            k,
          k = Xe(
            i,
            l,
      ...
      (U.plugOutline =
        (s = (r = e).options,
          ...
          y = !1,
          [0, 1].forEach(function (e) {
            var t = u.plugOutline_plugSE[e], n = t !== Y ? X[q[t]] : null;
            y = Xe(
              r,
              u.plugOutline_enabledSE,
              e,
              s.plugOutlineEnabledSE[e] && u.plug_enabled &&
                u.plug_enabledSE[e] && !!n && !!n.outlineBase,
            ) || y,
              y = Xe(
                r,
              ...
              ((t = s.plugOutlineSizeSE[e]) > n.outlineMax &&
                ...
                y = Xe(
                  ...
                  u.plugOutline_colorTraSE[e]
                    ? t -
                      se / (u.line_strokeWidth / ue.lineSize) /
                        s.plugSizeSE[e] * 2
                    : t / 2,
                ) || y);
          }),
      ...
      (U.faces =
        (g = (m = e).curStats,
          ...
          g.plug_enabled && [0, 1].forEach(function (n) {
            ...
            Xe(
              ...
              (Xe(m, _.plug_plugSE, n, e, v.apl_plug_plugSE) &&
                ...
                (Xe(m, _.plugOutline_plugSE, n, e, v.apl_plugOutline_plugSE) &&
                  ...
                  (m.plugOutlineMaskShapeSE[n].style.strokeWidth = S + "px",
                    E = !0),
                  Xe(
                    m,
      ...
      (U.path =
        (k = (x = e).curStats,
          ...
          (w.x1 = w.x2 = M[0][0].x,
            w.y1 = w.y2 = M[0][0].y,
            k.path_pathData = b = Be(M, function (e) {
              e.x < w.x1 && (w.x1 = e.x),
                e.y < w.y1 && (w.y1 = e.y),
                e.x > w.x2 && (w.x2 = e.x),
                e.y > w.y2 && (w.y2 = e.y);
            ...
            (x.linePath.setPathData(b),
              ...
              ie
                ...
                : oe && je(x, x.linePath),
              x.events.apl_path && x.events.apl_path.forEach(function (e) {
                e(x, b);
              }))),
          C)),
      U.viewBox =
        (M = (O = e).curStats,
          ...
          ["x", "y", "width", "height"].forEach(function (e) {
            ...
            (t = L[e]) !== A[e] &&
              (V[e] = A[e] = t,
                P[Q[e]] = t + ("x" === e || "y" === e ? O.bodyOffset[e] : 0) +
                  "px",
                N = !0);
          }),
          N),
      U.mask = (R = (W = e).curStats,
        F = W.aplStats,
        G = !1,
        R.plug_enabled
          ? [0, 1].forEach(function (e) {
        ...
        R.capsMaskMarker_enabled = R.capsMaskMarker_enabledSE[0] ||
          R.capsMaskMarker_enabledSE[1],
        R.lineMask_outlineMode = R.lineOutline_enabled,
        R.caps_enabled = R.capsMaskMarker_enabled ||
          R.capsMaskAnchor_enabledSE[0] || R.capsMaskAnchor_enabledSE[1],
        ...
        (W.lineFace.style.mask = B ? "url(#" + W.lineMaskId + ")" : "none",
          ...
          re && je(W, W.lineMask)),
        R.lineMask_enabled &&
        (Xe(W, F, "lineMask_outlineMode", B = R.lineMask_outlineMode) && (B
          ...
          R.caps_enabled && ([0, 1].forEach(function (e) {
            var t;
            Xe(
              W,
            ...
            R.capsMaskMarker_enabled && [0, 1].forEach(function (n) {
      ...
      (j = (D = e).curStats,
        ...
        Object.keys(Z).forEach(function (e) {
          var t = Z[e], n = e + "_enabled", a = e + "_options", e = j[a];
          Xe(D, H, n, z = j[n])
  ...
  function tt(e, t, n, a) {
    var i = e.curStats, o = e.aplStats, l = {};
    function r() {
  ...
  function it(s, u) {
    var i, n, e, t, a, o, l, r, h, p, c, d, f, y, m, S = s.options, g = {};
    ...
    function v(e, t, n, a, i, o, l) {
      ...
      return null != t[n] && (s = (t[n] + "").toLowerCase()) &&
        (l.acceptsAuto && s === D || (u = a[s])) && u !== l.container[l.key] &&
        (l.container[l.key] = u, r = !0),
        null != l.container[l.key] || l.acceptsAuto ||
      ...
      return null != t[n] &&
        (l.acceptsAuto && (t[n] + "").toLowerCase() === D ||
          (p = h = t[n],
            ...
            (!r || r(h)))) &&
        h !== l.container[l.key] && (l.container[l.key] = h, u = !0),
        null != l.container[l.key] || l.acceptsAuto ||
        ...
        ["start", "end"].forEach(function (e, t) {
          ...
          if (n && (Me(n) || (a = I(n, "anchor"))) && n !== S.anchorSE[t]) {
            if (
              ...
              at(s, _e[S.anchorSE[t]._id]), a && !nt(s, _e[n._id], e)
    ...
    (e = c,
      ...
      l.href.baseVal = "#" + c,
      n.lineMaskShape = l = n.lineMask.appendChild(
        y.createElementNS(ae, "use"),
      ),
      l.className.baseVal = C + "-line-mask-shape",
      l.href.baseVal = "#" + r,
      l.style.display = "none",
      n.lineMaskCaps = l = n.lineMask.appendChild(
        y.createElementNS(ae, "use"),
      ),
      l.href.baseVal = "#" + p,
      n.lineOutlineMask = k(x(e = m + "-line-outline-mask")),
      (l = n.lineOutlineMask.appendChild(y.createElementNS(ae, "use"))).href
        .baseVal = "#" + c,
      n.lineOutlineMaskShape = l = n.lineOutlineMask.appendChild(
        y.createElementNS(ae, "use"),
      ),
      l.className.baseVal = C + "-line-outline-mask-shape",
      l.href.baseVal = "#" + r,
      n.lineOutlineMaskCaps = l = n.lineOutlineMask.appendChild(
        y.createElementNS(ae, "use"),
      ),
      l.href.baseVal = "#" + p,
      ...
      l.href.baseVal = "#" + h,
      n.lineOutlineFace = l = n.face.appendChild(
        y.createElementNS(ae, "use"),
      ),
      l.href.baseVal = "#" + h,
      l.style.mask = "url(#" + e + ")",
      ...
      n.plugFaceSE = [0, 1].map(function (e) {
        return n.plugMarkerShapeSE[e].appendChild(
          y.createElementNS(ae, "use"),
        );
      }),
      ...
      [0, 1, 2].forEach(function (e) {
        ...
        e && I(e, "label") && (t = _e[e._id]).conf.initSvg &&
          t.conf.initSvg(t, n);
      }),
      g.line =
        g.plug =
      ...
      ["startLabel", "endLabel", "middleLabel"].forEach(function (e, t) {
        var n,
          ...
          i,
          o = u[e],
          l = S.labelSEM[t] && !s.optionIsAttach.labelSEM[t]
        ...
        if (
          ...
          if (
            S.labelSEM[t] && (at(s, _e[S.labelSEM[t]._id]), S.labelSEM[t] = ""),
              o
          ) {
            if (
              r
                ? (a = _e[(i = o)._id]).boundTargets.slice().forEach(
                  function (e) {
                    a.conf.removeOption(a, e);
                  },
                )
                : i = new M(O.captionLabel, [o]), !nt(s, _e[i._id], e)
            ) throw new Error("Can't bind attachment");
            S.labelSEM[t] = i;
          }
      ...
      Object.keys(Z).forEach(function (a) {
        var e, t, o = Z[a], n = a + "_enabled", i = a + "_options";
        function l(a) {
          var i = {};
        ...
        function r(e) {
          ...
          return e.hasOwnProperty("animation")
            ? he(e.animation)
  ...
  return Z = {
        ...
        n.dash_len = i.len || 2 * a.line_strokeWidth,
          ...
          n.dash_animOptions
            ? (o = Xe(t, a, "dash_maxOffset", n.dash_maxOffset),
              ...
              a.dash_animOptions || (n.dash_animId = g.add(
                function (e) {
    ...
    gradient: {
      ...
      init: function (e) {
        var a = e.baseWindow.document,
          t = e.defs,
          n = C + "-" + e._id + "-gradient";
        e.efc_gradient_gradient = t = t.appendChild(
          a.createElementNS(ae, "linearGradient"),
        ),
          t.id = n,
    ...
    dropShadow: {
      ...
      init: function (t) {
        var e,
          ...
          s = (e = o,
            ...
            o.id = n,
            u
              ? (i.elmOffset = i.elmBlur = a = o.appendChild(
                e.createElementNS(ae, "feDropShadow"),
              ),
                i.styleFlood = a.style)
              : (i.elmBlur = o.appendChild(
                e.createElementNS(ae, "feGaussianBlur"),
              ),
                i.elmOffset = a = o.appendChild(
                  e.createElementNS(ae, "feOffset"),
                ),
                a.result.baseVal = "offsetblur",
                a = o.appendChild(e.createElementNS(ae, "feFlood")),
                i.styleFlood = a.style,
                (a = o.appendChild(e.createElementNS(ae, "feComposite"))).in2
                  .baseVal = "offsetblur",
                a.operator.baseVal =
                  SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN,
                (a = o.appendChild(e.createElementNS(ae, "feMerge")))
                  .appendChild(e.createElementNS(ae, "feMergeNode")),
                a.appendChild(e.createElementNS(ae, "feMergeNode")).in1
                  .baseVal = "SourceGraphic"),
            i);
      ...
      adjustEdge: function (a, i) {
        var e, o = a.curStats, l = a.aplStats;
    ...
    ot.prototype.remove = function () {
      var t = Se[this._id], n = t.curStats;
      Object.keys(Z).forEach(function (e) {
        e += "_animId";
        n[e] && g.remove(n[e]);
      }),
    ...
    O = {
      pointAnchor: {
        ...
        init: function (e, t) {
          return e.element = O.pointAnchor.checkElement(t.element),
            e.x = O.pointAnchor.parsePercent(t.x, !0) || [.5, !0],
            e.y = O.pointAnchor.parsePercent(t.y, !0) || [.5, !0],
            !0;
        },
        removeOption: function (e, t) {
          ...
          i === e &&
          (i = e === document.body ? new M(O.pointAnchor, [i]) : document.body),
            a[t.optionName] = i,
            it(n, a);
        },
        getBBoxNest: function (e, t) {
          var n = Le(e.element, t.baseWindow), a = n.width, t = n.height;
        ...
        parsePercent: function (e, t) {
          ...
          return pe(e)
            ? a = e
            : "string" == typeof e && (n = m.exec(e)) && n[2] &&
      ...
      areaAnchor: {
        ...
        init: function (a, e) {
          var t, n = [];
          return a.element = O.pointAnchor.checkElement(e.element),
            ...
            "circle" === e.shape
              ? a.shape = e.shape
              : "polygon" === e.shape && Array.isArray(e.points) &&
                  3 <= e.points.length && e.points.every(function (e) {
                    var t = {};
                    return !(!(t.x = O.pointAnchor.parsePercent(e[0], !0)) ||
            ...
            (a.x = O.pointAnchor.parsePercent(e.x, !0) || [-.05, !0],
              a.y = O.pointAnchor.parsePercent(e.y, !0) || [-.05, !0],
        ...
        bind: function (e, t) {
          t = t.props;
          return e.color || Ge(t, "cur_line_color", e.updateColor),
        ...
        unbind: function (e, t) {
          ...
          e.color || De(t, "cur_line_color", e.updateColor),
            ...
            1 < e.boundTargets.length && ze(function () {
              e.updateColor(),
                e.updateShow(),
                O.areaAnchor.update(e) && e.boundTargets.forEach(function (e) {
        ...
        getStrokeWidth: function (e, t) {
          return O.areaAnchor.update(e) && 1 < e.boundTargets.length &&
            ze(function () {
        ...
        update: function (t) {
            ...
            switch (t.shape) {
                ...
                (c = {
                  ...
                  h = (r = t.radius ? t.radius <= s ? t.radius : s : 0)
                    ? (s = (r - p) / Math.SQRT2,
                      ...
                      S.pathListRel.push([h[2], { x: h[2].x + p, y: h[2].y }, {
                        x: h[3].x,
                        y: h[3].y - p,
                      }, h[3]]),
                      h[3].y !== h[4].y && S.pathListRel.push([h[3], h[4]]),
                      S.pathListRel.push([h[4], { x: h[4].x, y: h[4].y + p }, {
                        x: h[5].x + p,
                        y: h[5].y,
                      }, h[5]]),
                      h[5].x !== h[6].x && S.pathListRel.push([h[5], h[6]]),
                      S.pathListRel.push([h[6], { x: h[6].x - p, y: h[6].y }, {
                        x: h[7].x,
                        y: h[7].y + p,
                      }, h[7]]),
              ...
              case "circle":
                (l = {
                  ...
                  width: t.width[0] * (t.width[1] ? n.width : 1),
                  height: t.height[0] * (t.height[1] ? n.height : 1),
                }).width || l.height || (l.width = l.height = 10),
                  ...
                  S.pathListRel = [[
                    ...
                    e[1],
                  ], [e[1], { x: e[1].x + r, y: e[1].y }, {
                    x: e[2].x,
                    y: e[2].y - p,
                  }, e[2]], [e[2], { x: e[2].x, y: e[2].y + p }, {
                    x: e[3].x + r,
                    y: e[3].y,
                  }, e[3]], [e[3], { x: e[3].x - r, y: e[3].y }, {
                    x: e[0].x,
                    y: e[0].y + p,
                  }, e[0]], []],
                  s = c - s + S.strokeWidth / 2,
                  u = h - u + S.strokeWidth / 2,
                  e = [{ x: l.left - s, y: l.top - u }, {
                    x: l.right + s,
                    y: l.bottom + u,
                  }],
                  S.bBoxRel = {
          ...
          return (v.pathListRel || v.elementLeft || v.elementTop) &&
            ...
            ["x", "y", "width", "height"].forEach(function (e) {
              (a = d[e]) !== f[e] &&
                (y[e] = f[e] = a,
                  m[Q[e]] = a + ("x" === e || "y" === e ? t.bodyOffset[e] : 0) +
                    "px");
            }),
      ...
      mouseHoverAnchor: {
        ...
        dirKeys: [["top", "Top"], ["right", "Right"], ["bottom", "Bottom"], [
          "left",
          "Left",
        ]],
        init: function (a, i) {
          var n, t, e, o, l, r, s, u, h, p = O.mouseHoverAnchor, c = {};
          if (
            a.element = O.pointAnchor.checkElement(i.element),
              s = a.element,
              !((u = s.ownerDocument) && (h = u.defaultView) && h.HTMLElement &&
                s instanceof h.HTMLElement)
          ) throw new Error("`element` must be HTML element");
          return p.style.backgroundSize = p.backgroundSize.width + "px " +
            p.backgroundSize.height + "px",
            ...
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              e = "padding" + e[1];
              a.style[e] &&
                (c[e] = a.element.style[e], a.element.style[e] = a.style[e]);
            }),
            (s = a.element.getBoundingClientRect()).height < p.minHeight &&
            (ie
              ? (h = p.minHeight,
                "content-box" === n.boxSizing
                  ? h -= parseFloat(n.borderTopWidth) +
                    parseFloat(n.borderBottomWidth) + parseFloat(n.paddingTop) +
              ...
              : a.style.height = parseFloat(n.height) +
                (p.minHeight - s.height) + "px"),
            a.style.backgroundPosition = re
              ? s.width - p.backgroundSize.width - p.backgroundPosition.right +
                "px " + p.backgroundPosition.top + "px"
              : "right " + p.backgroundPosition.right + "px top " +
                p.backgroundPosition.top + "px",
            ...
            i.showEffectName && w[i.showEffectName] &&
        ...
        unbind: function (e, t) {
          e.enabled && e.boundTargets.length <= 1 &&
          (e.removeEventListener(),
      ...
      captionLabel: {
        ...
        init: function (l, t) {
          return "string" == typeof t.text && (l.text = t.text.trim()),
            !!l.text &&
            ("string" == typeof t.color && (l.color = t.color.trim()),
              l.outlineColor = "string" == typeof t.outlineColor
                ? t.outlineColor.trim()
                : "#fff",
              Array.isArray(t.offset) && pe(t.offset[0]) && pe(t.offset[1]) &&
        ...
        updateColor: function (e, t) {
          var n = e.curStats, a = e.aplStats, t = t.curStats;
          ...
          return r.textContent = e,
            ...
            i && !h
              ? (o = t.createElementNS(ae, "defs"),
                ...
                (t = e.appendChild(t.createElementNS(ae, "use"))).href.baseVal =
                  "#" + a,
        ...
        initSvg: function (t, n) {
          ...
          ["elmPosition", "styleFill", "styleShow", "elmsAppend"].forEach(
            ...
            t.outlineColor &&
            (a = e.height / 9,
              i.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) +
                "px",
        ...
        bind: function (e, t) {
          var n = t.props;
          return e.color || Ge(n, "cur_line_color", e.updateColor),
            (e.refSocketXY = "startLabel" === t.optionName ||
      ...
      pathLabel: {
          ...
          return "string" == typeof t.text && (l.text = t.text.trim()),
            ...
            ("string" == typeof t.color && (l.color = t.color.trim()),
              ...
              l.updatePath = function (e) {
                ...
                i &&
                  (t.pathData = a = O.pathLabel.getOffsetPathData(
                    i,
              ...
              l.updateStartOffset = function (e) {
                var i, t, n = l.curStats, a = l.aplStats, o = e.curStats;
                n.pathData &&
                  (2 === l.semIndex && !l.lineOffset ||
                    (t = n.pathData.reduce(function (e, t) {
                      ...
                      ) + l.strokeWidth / 2 + l.height / 4,
                        e = (e += 0 === l.semIndex ? o : -o) < 0
                          ? 0
                          : t < e
                          ? t
                          : e),
          ...
          return e.forEach(function (e) {
            ...
            2 === e.length
              ? (s = e[0],
                u = e[1],
                h = c,
                p = Math.atan2(s.y - u.y, u.x - s.x) + .5 * Math.PI,
                t = [{
                  x: s.x + Math.cos(p) * h,
                ...
                d
                  ? (a = d.points,
                    0 <=
                        (r = Math.atan2(a[1].y - a[0].y, a[0].x - a[1].x) -
                      ...
                      : (o = Pe(a[0], a[1], c),
                        ...
                        r = s.x - i.x,
                        u = s.y - i.y,
                        s = (-h * (l.x - i.x) + p * (l.y - i.y)) /
                          (-r * h + p * u),
                        u = (r * (l.y - i.y) - u * (l.x - i.x)) /
                          (-r * h + p * u),
                        n = (h = 0 <= s && s <= 1 && 0 <= u && u <= 1
                            ? { x: l.x + u * p, y: l.y + u * h }
                            : null)
          ...
          return u.id = i = n + "-path",
            ...
            a && !h
              ? (o.id = e = n + "-text",
                ...
                (t = n.appendChild(t.createElementNS(ae, "use"))).href.baseVal =
                  "#" + e,
        ...
        initSvg: function (t, n) {
          ...
          [
            ...
            o.elmPath.setPathData([{ type: "M", values: [0, 100] }, {
              type: "h",
              values: [100],
            }]),
            ...
            t.outlineColor &&
            (a = e.height / 9,
              o.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) +
                "px",
        ...
        bind: function (e, t) {
          ...
          return e.color || Ge(n, "cur_line_color", e.updateColor),
            ...
            Ge(n, "apl_path", e.updatePath),
            e.semIndex = "startLabel" === t.optionName
              ? 0
              : "endLabel" === t.optionName
              ? 1
              : 2,
